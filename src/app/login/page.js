          ...
          <div>
            <div className="p-5 space-y-2 rounded-xl text-neutral">
              ...
              <h1 className="text-[20px] font-bold text-center">
                Welcome to <span className="text-red-700">DRUG INTERNATIONAL LIMITED</span>{" "}
              </h1>
              ...
              >
                ...
                <button
                  type="submit"
                  className="block w-full p-3 text-center px-6 font-bold text-white border-md rounded-md  bg-blue-500"
                >
                  Log in
                </button>
              </form>
              ...
              <p className="text-xs text-center">
                Don’t remember your password? Recover it if you Forgot!
              </p>
              <p className="text-xs text-center">
